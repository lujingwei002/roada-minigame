CREATE DATABASE IF NOT EXISTS daxigua DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_general_ci;
USE daxigua;
...
DROP TABLE IF EXISTS `daxigua`;
CREATE TABLE `daxigua` (
    `userid` bigint(11) AUTO_INCREMENT COMMENT '用户id',
    `createtime` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
    `updatetime` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
    PRIMARY KEY (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='合成大西瓜';
